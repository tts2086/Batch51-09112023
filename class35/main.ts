let Animal=['Dolphin', 'Bat', 'Whale']
let AnimalAblity=['It use echolocation to navigate and locate prey underwater ', 'use echolocation for navigation and hunting',
                  ' as toothed whales, use echolocation to locate prey']
...
for(var i=0;i<=Animal.length-1;i++)
{
    ...
    console.log(Animal[i]+ ' is '+ AnimalAblity[i]+'\n');
}


console.log('\n'+Animal+ ' are use ablity of Echolocation\n');
