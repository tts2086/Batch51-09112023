...
for (;;) {
    var name_1 = prompt("Enter User name ?, B for break loop ");
    //console.log(usernames[usernames.indexOf(name)], name); 
    if (usernames[usernames.indexOf(name_1)] === 'admin') {
        console.log('Hello admin, would you like to see a status report?');
    }
    else if (usernames[usernames.indexOf(name_1)] !== 'admin' && usernames.indexOf(name_1) >= 0) {
        console.log('Hello ' + usernames[usernames.indexOf(name_1)] + ', thank you for logging in again');
    }
